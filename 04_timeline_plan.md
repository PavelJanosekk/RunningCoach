...
zlepšovat rychlost. → Priorita: kvalitní threshold + bezpečně rostoucí objem,
dojít na start zdravý a nepřestřelit začátek.
...
5. **MP bloky jet podle aktuální predikce** (teď ~5:15–5:25), závodní tempo
   až po PM 3.4. — viz `02`. 3:50 = 5:27/km, 3:40 = 5:13/km, sub-4 = 5:41/km.
...
- Základní peak **60–65 km**; 68 km jen bonus, pokud prosinec–leden
  proběhnou bez problémů. Pro 3:40–3:50 víc netřeba.
...
**Sopky (domluvené jeepové výlety):** Bromo 26.9. (výhled + ~250 schodů
na kráter), Ijen 28.9. (teď zavřený; jinak noční výstup ~3 km / ~500 m),
Merapi lava tour 2.10. (jeep, výstup nejistý), Batur 7.10. (východ slunce,
~700 m nahoru i dolů). **Všechny sestupy ≤800 m → normální dny**, žádné
omezení běhu kvůli excentrice.
- Hlavní cena je **spánek** (budíčky 1–3 h ráno): v den výletu neběhat;
  další den běžet jen po ≥6 h spánku, jinak posunout.
- Bromo ~2300–2750 m a za úsvitu zima (5–10 °C) → teplá vrstva.
- Batur: sypký štěrk dolů → krátké kroky; další den jen chůze.
- Kdyby přibyla velká sopka (sestup ≥1200 m, např. Agung / Rinjani): = long
  run týdne, 48 h neběhat, pak ≤6 km easy, 5 dní nic >8 km.
...
|---|---|
| Čt 24.9. | let |
| Pá 25.9. | přílet, chůze |
| So 26.9. | **Bromo** — neběhat |
| Ne 27.9. | easy 4–5 km (aklimatizace) |
| Po 28.9. | **Ijen** (pokud otevřeno) — neběhat |
| Út 29.9. | volno / silový okruh |
| St 30.9. | easy 5–6 km + **sweat test** |
| Pá 2.10. | **Merapi** — neběhat |
| So 3.10. | easy 6–8 km |
| Po 5.10. | easy 6–8 km + 4 strides (ráno za chladu) |
| Út 6.10. | silový okruh |
| St 7.10. | **Batur** — neběhat |
| Čt 8.10. | volno, chůze |
| Pá 9.10. | easy 8–10 km — nejdelší běh pobytu |
| So 10.10. | easy 5–6 km nebo volno |
| Ne 11.10. | odlet |

Celkem ~35–43 km. Dny posouvat podle programu; pravidlo = 2 běhy/týden,
nikdy v den výletu, HR ≤150.
...
| 9 | 12.–18.4. | 60–65 (68 bonus) | **30 (10–12 km @ MP)** | jediný peak; LR 17./18.4. |
...
- Boty: Novablast 5 — 2. pár ~prosinec (střídat), 3. pár v březnu = závodní,
  naběhat 100–200 km do závodu vč. PM (viz `10`).

---

## Týdenní šablony (LR v neděli)
```
            Teď (4 běhy, LR ≤17 km)           Od 2.11. (5 běhů, LR ≥18 km)
Po  volno                                 volno + PULL
Út  KVALITA + PULL                        Q1 + TĚŽKÝ LOWER odpoledne
St  easy + PUSH                           easy 7–8 km + PUSH
Čt  volno / mobilita                      easy 6 km + strides
Pá  easy (+ lehký lower 20 min)           easy 5–6 km (od týdne 9 Q2) + max 15 min lýtka/plyo
So  volno + UPPER                         volno + UPPER
Ne  LONG RUN + LOWER odpoledne            LONG RUN
```
- Tvůj současný split (Út pull, St push, So upper, Ne lower) je OK, dokud
  je LR ≤16–17 km a lehký. Od LR 18 km přesunout lower na úterý po kvalitě.
- 5. běh (od 26.10.) = čtvrtek.
